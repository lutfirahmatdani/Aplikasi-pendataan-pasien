                ...
                <div class="card-body">
                    <form action="/pasien/update/<?= $pasien['id']; ?>" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= ($validation->hasError('penyakit')) ? 'is-invalid' : ''; ?>" id="penyakit" name="penyakit" value="<?= (old('penyakit')) ? old('penyakit') : $pasien['penyakit']; ?>">
                                <div class="invalid-feedback">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control <?= ($validation->hasError('ruang')) ? 'is-invalid' : ''; ?>" id="ruang" name="ruang" value="<?= (old('ruang')) ? old('ruang') : $pasien['ruang']; ?>">
                                <div class="invalid-feedback">
